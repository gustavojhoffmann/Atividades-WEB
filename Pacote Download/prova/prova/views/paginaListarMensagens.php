...
<div id="mainContent" style="text-align: center;">
	...
	<div class="table-responsive" id="listagem">
		<table class="table table-striped">
			...
			<tr>
				...
				<td><button type="button" class="btn btn-primary" onclick="responderMensagem(<?php echo $contato->getCodigo(); ?>)">Responder</button></td>
				<td></td>
			</tr>
			<?php			
		}
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
	...
	<script>
	function responderMensagem(codigo) {
		window.location = "<?php echo URL_BASE.'/views/paginaResposta.php?codigo='; ?>" + codigo;
	}
	</script>
